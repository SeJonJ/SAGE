...
3. `sage/project-profile.yaml` — `team.core.implementer-b.owns` (your component id), `components`, `conventions`
4. Optional project overlay: `sage/asset_overrides/agents/implementer-b.md`
...
of the component id specified in `profile.team.core.implementer-b.owns`.
