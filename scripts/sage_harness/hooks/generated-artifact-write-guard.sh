...
is_guarded() {
  ...
  #   CORE skill(sage-init/pdca-start/sage-review/sage-asset/sage-profile-modify) 렌더 + CORE 로스터 6인 에이전트 렌더.
  ...
  case "$p" in
    *.claude/skills/sage-init/*|*.claude/skills/pdca-start/*|*.claude/skills/sage-review/*|*.claude/skills/sage-asset/*|*.claude/skills/sage-profile-modify/*) return 1 ;;
