...
from sage.commands import install, generate, validate, asset_check, absorb, doctor, change, override, review_loop, retro, knowledge

_COMMANDS = [install, generate, validate, asset_check, absorb, doctor, change, override, review_loop, retro, knowledge]
