...
host 택1이라 호스트별 위치가 다름: claude=repo `.claude/skills/{sage-init,sage-init-local,sage-cycle,sage-plan,sage-team,sage-review,sage-asset,sage-asset-override,sage-profile-modify,sage-feedback}` +
