<!-- sage-doc-source: ARTIFACTS.md sha256:37125b77f3dbb1f17f2295f1b0def0776c077e214d46b36dd0bdca465f67bffb -->
# SAGE Artifact Map
...
| `.sage/acceptance-waivers.jsonl.lock` | Local | `msvcrt` lock sidecar for the acceptance waiver audit, created **on Windows only**. POSIX locks the `.sage` directory itself, so this file does not exist there. It is neither authority nor audit evidence and remains ignored by the wildcard rule | `acceptance_waiver._nt_lock` |
